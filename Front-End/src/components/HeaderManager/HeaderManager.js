    ...
    return (
      <div>
        <nav className="navbar navbar-expand navbar-dark bg-dark static-top">
          <a className="navbar-brand mr-1" href=''>{this.webService.isAdmin() ? 'Admin' : 'Locate Indentify'} <span style={{ "color": "red", "fontSize" : "1em" }}>{this.webService.getUserName()}</span></a>
          {/* Navbar Search */}
